...
const ForgotPassword = ({ onBack }) => {
  ...
  const S = {
    ...
    otpInput: {
      ...
      backgroundColor: "#fafafa", outline: "none",
      transition: "border-color 0.15s",
      fontFamily: "inherit", letterSpacing: 8, textAlign: "center",
    },
    btn: {
      width: "100%", boxSizing: "border-box",
    ...
    backBtn: {
      ...
      fontSize: 13, color: "#999", padding: 0, marginBottom: 20,
      fontFamily: "inherit",
    },
    hint: {
    ...
    footerLink: {
      fontWeight: 700, color: "#111", background: "none", border: "none",
  ...
  const focusBorder = (e) => { e.target.style.borderColor = "#111"; e.target.style.backgroundColor = "#fff"; };
  const blurBorder = (e) => { e.target.style.borderColor = "#f0f0f0"; e.target.style.backgroundColor = "#fafafa"; };

  const stepIndex = { [STEP.EMAIL]: 0, [STEP.OTP]: 1, [STEP.RESET]: 2, [STEP.DONE]: 3 }[step];
  ...
  return (
    <div style={S.page}>
      <div style={S.card}>
        ...
        {step === STEP.EMAIL && (
          <>
            ...
            <form onSubmit={handleSendEmail} style={S.fields}>
              <div>
                <p style={S.hint}>
                  Nhập địa chỉ email đã đăng ký để nhận mã xác thực OTP.
                </p>
              </div>
        ...
        {step === STEP.OTP && (
          <>
            ...
            <form onSubmit={handleVerifyOtp} style={S.fields}>
              ...
              <button
                type="button"
                style={{ ...S.backBtn, margin: "4px auto 0", justifyContent: "center" }}
        ...
        {step === STEP.RESET && (
          <>
            <button style={S.backBtn} onClick={() => setStep(STEP.OTP)}>
